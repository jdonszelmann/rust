...
complete -c x.py -n "__fish_x.py_using_subcommand test" -l coverage-report -d 'Generate a coverage report for compiler tests. Used mainly for CI to verify all code in the compiler is reached in tests'
