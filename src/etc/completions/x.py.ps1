...
Register-ArgumentCompleter -Native -CommandName 'x.py' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'x.py;test' {
            ...
            [CompletionResult]::new('--coverage-report', '--coverage-report', [CompletionResultType]::ParameterName, 'Generate a coverage report for compiler tests. Used mainly for CI to verify all code in the compiler is reached in tests')
            [CompletionResult]::new('-v', '-v', [CompletionResultType]::ParameterName, 'use verbose output (-vv for very verbose)')
            [CompletionResult]::new('--verbose', '--verbose', [CompletionResultType]::ParameterName, 'use verbose output (-vv for very verbose)')
            [CompletionResult]::new('-i', '-i', [CompletionResultType]::ParameterName, 'use incremental compilation')
            [CompletionResult]::new('--incremental', '--incremental', [CompletionResultType]::ParameterName, 'use incremental compilation')
