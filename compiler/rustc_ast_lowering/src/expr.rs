...
impl<'hir> LoweringContext<'_, 'hir> {
    ...
    pub(super) fn lower_expr_mut(&mut self, e: &Expr) -> hir::Expr<'hir> {
        ensure_sufficient_stack(|| {
                    ...
                    if !e.attrs.is_empty() {
                        ...
                        self.attrs.insert(
                            ...
                            &*self.arena.alloc_from_iter(
                                self.lower_attrs_vec(&e.attrs, e.span, e.id)
                                    .into_iter()
            ...
            self.lower_attrs(expr_hir_id, &e.attrs, e.span, e.id);
    ...
    fn lower_arm(&mut self, arm: &Arm) -> hir::Arm<'hir> {
        ...
        self.lower_attrs(hir_id, &arm.attrs, arm.span, arm.id);
    ...
    fn lower_expr_field(&mut self, f: &ExprField) -> hir::ExprField<'hir> {
        ...
        self.lower_attrs(hir_id, &f.attrs, f.span, f.id);
        hir::ExprField {
            hir_id,
            ident: self.lower_ident(f.ident),
    ...
    fn lower_expr_for(
        ...
        self.lower_attrs(expr.hir_id, &e.attrs, e.span, e.id);
        expr
    }
    ...
    fn lower_expr_try(&mut self, span: Span, sub_expr: &Expr) -> hir::ExprKind<'hir> {
        ...
        let continue_arm = {
            ...
            self.lower_attrs(val_expr.hir_id, &attrs, span, sub_expr.node_id());
        ...
        let break_arm = {
            ...
            self.lower_attrs(ret_expr.hir_id, &attrs, span, sub_expr.node_id());
