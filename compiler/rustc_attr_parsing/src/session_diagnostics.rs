...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for UnsupportedLiteral {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        let mut diag = Diag::new(dcx, level, match self.reason {
            ...
            UnsupportedLiteralReason::CfgString => fluent::attr_parsing_unsupported_literal_cfg_string,
            UnsupportedLiteralReason::CfgBoolean => fluent::attr_parsing_unsupported_literal_cfg_boolean,
...
pub(crate) enum IncorrectReprFormatGenericCause<'a> {
    #[suggestion(attr_parsing_suggestion, code = "{name}({int})", applicability = "machine-applicable")]
    Int {
        #[primary_span]
        span: Span,
    ...
    #[suggestion(attr_parsing_suggestion, code = "{name}({symbol})", applicability = "machine-applicable")]
    Symbol {
        #[primary_span]
        span: Span,
